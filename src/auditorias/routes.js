...
const routes = [
  ...
  { path: '/logout', name: 'Saliendo', component: Logout },
  { path: '/users', exact: true,  name: 'Users', component: Users },
  { path: '/users/:id', exact: true, name: 'User Details', component: User },
  { path: '/iglesias', exact: true, name: 'Iglesias', component: Iglesias },
  { path: '/iglesias/add', exact: true, name: 'Añadir Iglesia', component: AddEditIglesia },
  { path: '/iglesias/edit/:id', exact: true, name: 'Editar Iglesia', component: AddEditIglesia },
